...
export type AssignmentBuyoutPolicy = {
  __typename?: 'AssignmentBuyoutPolicy';
  category?: Maybe<Category>;
  createdAt: Scalars['Float']['output'];
  id: Scalars['ID']['output'];
  isFree: Scalars['Int']['output'];
  minEmploymentMonths: Scalars['Int']['output'];
  name: Scalars['String']['output'];
  paymentPercent: Scalars['Float']['output'];
};

export type AssignmentFinancing = {
  __typename?: 'AssignmentFinancing';
  ...
  payments: Array<AssignmentPayment>;
  totalPayment?: Maybe<Scalars['Float']['output']>;
  updatedAt: Scalars['Float']['output'];
};

export type AssignmentPayment = {
  __typename?: 'AssignmentPayment';
  amount: Scalars['Int']['output'];
  createdAt: Scalars['Float']['output'];
  dueDate: Scalars['Float']['output'];
  financingId: Scalars['ID']['output'];
  id: Scalars['ID']['output'];
...
export type DataWipeTask = {
  __typename?: 'DataWipeTask';
  asset?: Maybe<Asset>;
  assetId: Scalars['ID']['output'];
  createdAt: Scalars['Float']['output'];
  id: Scalars['ID']['output'];
  latestAssignment?: Maybe<Assignment>;
  latestReturnRequest?: Maybe<OffboardingReturnRequest>;
  status: Scalars['String']['output'];
  updatedAt: Scalars['Float']['output'];
};
...
export type EmployeeCreateInput = {
  ...
  signUrl?: InputMaybe<Scalars['String']['input']>;
  status?: InputMaybe<Scalars['String']['input']>;
...
export type Mutation = {
  ...
  createDataWipeTask: DataWipeTask;
  ...
  /** HR: эвдрэлтэй бол зураг (R2) + засварын хүсэлт IT руу, asset REPAIR_REQUESTED */
  requestRepair: Asset;
  ...
  updateAssignmentStatus?: Maybe<Assignment>;
  updateCategory?: Maybe<Category>;
  updateDataWipeTask: DataWipeTask;
...
export type MutationApproveReturnRequestArgs = {
  conditionHr: Scalars['String']['input'];
...
export type MutationAssignAssetArgs = {
  ...
  assetId: Scalars['ID']['input'];
  assignedValue?: InputMaybe<Scalars['Float']['input']>;
  buyoutPolicyId?: InputMaybe<Scalars['ID']['input']>;
...
export type MutationCreateDataWipeTaskArgs = {
  assetId: Scalars['ID']['input'];
};
...
export type MutationRequestRepairArgs = {
  conditionHr: Scalars['String']['input'];
  inspectedBy: Scalars['ID']['input'];
  photoR2Key?: InputMaybe<Scalars['String']['input']>;
  returnRequestId: Scalars['ID']['input'];
};
...
export type MutationSubmitReturnRequestArgs = {
  assetId: Scalars['ID']['input'];
  condition: Scalars['String']['input'];
  conditionDetail?: InputMaybe<Scalars['String']['input']>;
  employeeId: Scalars['ID']['input'];
  photoR2Key?: InputMaybe<Scalars['String']['input']>;
};
...
export type MutationUpdateDataWipeTaskArgs = {
  id: Scalars['ID']['input'];
  status: Scalars['String']['input'];
};
...
export type OffboardingEvent = {
  ...
  assetIdsJson: Scalars['String']['output'];
  /** assetIdsJson-д хадгалсан ID-аар assets хүснэгтээс шүүж авсан буцаах хөрөнгийн жагсаалт */
  assetsToReturn: Array<Asset>;
  ...
  /** HR шалгах хүлээгдэж буй буцаах хүсэлтүүд (status=PENDING_HR) */
...
export type OffboardingReturnRequest = {
  __typename?: 'OffboardingReturnRequest';
  asset?: Maybe<Asset>;
  assetId: Scalars['ID']['output'];
  assignmentId: Scalars['ID']['output'];
  conditionEmployee: Scalars['String']['output'];
  conditionHr?: Maybe<Scalars['String']['output']>;
  createdAt: Scalars['Float']['output'];
  employee?: Maybe<Employee>;
  employeeId: Scalars['ID']['output'];
  id: Scalars['ID']['output'];
  inspectedBy?: Maybe<Scalars['ID']['output']>;
  offboardingEventId: Scalars['ID']['output'];
  photoR2Key?: Maybe<Scalars['String']['output']>;
  status: Scalars['String']['output'];
  updatedAt: Scalars['Float']['output'];
};
...
export type QueryDataWipeTasksArgs = {
  status?: InputMaybe<Scalars['String']['input']>;
};
...
export type QueryPendingReturnRequestsArgs = {
  offboardingEventId: Scalars['ID']['input'];
};
...
export type GetActiveDisposalsQuery = { __typename?: 'Query', disposalRequests: Array<{ __typename?: 'DisposalRequest', id: string, assetId: string, method: string, reason?: string | null, status: string, createdAt: number, asset?: { __typename?: 'Asset', id: string, assetTag: string, category: string } | null, requestedBy?: { __typename?: 'Employee', id: string, firstName: string, lastName: string, email: string } | null }> };

export type GetDisposalRequestsQueryVariables = Exact<{
  status?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetDisposalRequestsQuery = { __typename?: 'Query', disposalRequests: Array<{ __typename?: 'DisposalRequest', id: string, assetId: string, method: string, reason?: string | null, status: string, createdAt: number, asset?: { __typename?: 'Asset', id: string, assetTag: string, category: string } | null, requestedBy?: { __typename?: 'Employee', id: string, firstName: string, lastName: string, email: string } | null }> };
...
export type GetActiveOffboardingQuery = { __typename?: 'Query', offboardingEvent?: { __typename?: 'OffboardingEvent', id: string, status: string, totalAssets: number, returnedAssets: number, assetIdsJson: string, deadline?: number | null, completedAt?: number | null, createdAt: number, assetsToReturn: Array<{ __typename?: 'Asset', id: string, assetTag: string, serialNumber: string }>, pendingReturnRequests: Array<{ __typename?: 'OffboardingReturnRequest', id: string, assetId: string, conditionEmployee: string, status: string, photoR2Key?: string | null, asset?: { __typename?: 'Asset', id: string, assetTag: string, serialNumber: string } | null }> } | null };
...
export type UpdateAssignmentStatusMutationVariables = Exact<{
  assignmentId: Scalars['ID']['input'];
  status: Scalars['String']['input'];
}>;


export type UpdateAssignmentStatusMutation = { __typename?: 'Mutation', updateAssignmentStatus?: { __typename?: 'Assignment', id: string, status: string } | null };
...
export type AssignmentFieldsFragment = { __typename?: 'Assignment', id: string, assetId: string, employeeId: string, assignedAt: number, returnedAt?: number | null, conditionAtAssign: string, conditionAtReturn?: string | null, status: string, financing?: { __typename?: 'AssignmentFinancing', assignedValue?: number | null, paymentPlanMonths?: number | null, interestRate?: number | null, monthlyPayment?: number | null, totalPayment?: number | null } | null, asset?: (
    { __typename?: 'Asset' }
    & { ' $fragmentRefs'?: { 'AssetFieldsFragment': AssetFieldsFragment } }
  ) | null, employee?: { __typename?: 'Employee', id: string, email: string, firstName: string, lastName: string } | null, requestedBy?: { __typename?: 'Employee', id: string, firstName: string, lastName: string } | null } & { ' $fragmentName'?: 'AssignmentFieldsFragment' };
...
export type CreateDataWipeTaskMutationVariables = Exact<{
  assetId: Scalars['ID']['input'];
}>;


export type CreateDataWipeTaskMutation = { __typename?: 'Mutation', createDataWipeTask: { __typename?: 'DataWipeTask', id: string, assetId: string, status: string, createdAt: number, updatedAt: number } };

export type GetDataWipeTasksQueryVariables = Exact<{
  status?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetDataWipeTasksQuery = { __typename?: 'Query', dataWipeTasks: Array<{ __typename?: 'DataWipeTask', id: string, assetId: string, status: string, createdAt: number, updatedAt: number, asset?: { __typename?: 'Asset', id: string, assetTag: string, category: string } | null, latestAssignment?: { __typename?: 'Assignment', id: string, employee?: { __typename?: 'Employee', id: string, firstName: string, lastName: string, department: string, branch: string } | null } | null, latestReturnRequest?: { __typename?: 'OffboardingReturnRequest', id: string, employee?: { __typename?: 'Employee', id: string, firstName: string, lastName: string, department: string, branch: string } | null } | null }> };

export type UpdateDataWipeTaskMutationVariables = Exact<{
  id: Scalars['ID']['input'];
  status: Scalars['String']['input'];
}>;


export type UpdateDataWipeTaskMutation = { __typename?: 'Mutation', updateDataWipeTask: { __typename?: 'DataWipeTask', id: string, status: string, updatedAt: number } };

export type EmployeesQueryVariables = Exact<{ [key: string]: never; }>;


export type EmployeesQuery = { __typename?: 'Query', employees: Array<{ __typename?: 'Employee', id: string, entraId?: string | null, firstName: string, lastName: string, firstNameEng: string, lastNameEng: string, email: string, role: string, imageUrl?: string | null, signUrl?: string | null, hireDate: number, terminationDate?: number | null, status: string, numberOfVacationDays?: number | null, github?: string | null, department: string, branch: string, employeeCode: string, level: string, isKpi: number, isSalaryCompany: number, birthDayAndMonth?: string | null, birthdayPoster?: string | null, createdAt: number, updatedAt: number, deletedAt?: number | null }> };
...
export type AssetFieldsFragment = { __typename?: 'Asset', id: string, assetTag: string, serialNumber: string, status: string, category: string, purchaseDate?: number | null, purchaseCost?: number | null, currentBookValue?: number | null, locationId?: string | null, locationPath?: string | null, assignedTo?: string | null, imageUrl?: string | null, notes?: string | null, createdAt: number, updatedAt: number } & { ' $fragmentName'?: 'AssetFieldsFragment' };

export type EmployeeFieldsFragment = { __typename?: 'Employee', id: string, firstName: string, lastName: string, email: string, role: string, department: string, branch: string, imageUrl?: string | null, signUrl?: string | null } & { ' $fragmentName'?: 'EmployeeFieldsFragment' };
...
export type GetEmployeeAssignmentsQueryVariables = Exact<{
  employeeId: Scalars['ID']['input'];
  status?: InputMaybe<Scalars['String']['input']>;
}>;


export type GetEmployeeAssignmentsQuery = { __typename?: 'Query', employeeAssignments: Array<{ __typename?: 'Assignment', id: string, assetId: string, employeeId: string, assignedAt: number, returnedAt?: number | null, conditionAtAssign: string, conditionAtReturn?: string | null, status: string, financing?: { __typename?: 'AssignmentFinancing', assignedValue?: number | null, paymentPlanMonths?: number | null, interestRate?: number | null, monthlyPayment?: number | null, totalPayment?: number | null } | null, asset?: { __typename?: 'Asset', id: string, assetTag: string, category: string, serialNumber: string, imageUrl?: string | null, locationId?: string | null, locationPath?: string | null, purchaseCost?: number | null, currentBookValue?: number | null, assignedTo?: string | null } | null, employee?: { __typename?: 'Employee', id: string, email: string, firstName: string, lastName: string } | null, requestedBy?: { __typename?: 'Employee', id: string, firstName: string, lastName: string } | null }> };
...
export type UpdateMaintenanceTicketMutation = { __typename?: 'Mutation', updateMaintenanceTicket: { __typename?: 'MaintenanceTicket', id: string, status: string, resolvedAt?: number | null, updatedAt: number } };
...
export type GetOffboardingEventQuery = { __typename?: 'Query', offboardingEvent?: { __typename?: 'OffboardingEvent', id: string, status: string, totalAssets: number, returnedAssets: number, assetIdsJson: string, deadline?: number | null, completedAt?: number | null, createdAt: number, employee?: { __typename?: 'Employee', id: string, firstName: string, lastName: string, email: string } | null, initiatedBy?: { __typename?: 'Employee', id: string, firstName: string, lastName: string } | null, assetsToReturn: Array<{ __typename?: 'Asset', id: string, assetTag: string, serialNumber: string }> } | null };
...
export type SubmitReturnRequestMutationVariables = Exact<{
  assetId: Scalars['ID']['input'];
  employeeId: Scalars['ID']['input'];
  condition: Scalars['String']['input'];
  conditionDetail?: InputMaybe<Scalars['String']['input']>;
...
export type SubmitReturnRequestMutation = { __typename?: 'Mutation', submitReturnRequest: { __typename?: 'OffboardingReturnRequest', id: string, assetId: string, status: string, conditionEmployee: string } };
...
export type ApproveReturnRequestMutation = { __typename?: 'Mutation', approveReturnRequest: { __typename?: 'Asset', id: string, assetTag: string, status: string } };

export type RequestRepairMutationVariables = Exact<{
  returnRequestId: Scalars['ID']['input'];
  conditionHr: Scalars['String']['input'];
  photoR2Key?: InputMaybe<Scalars['String']['input']>;
  inspectedBy: Scalars['ID']['input'];
...
export type RequestRepairMutation = { __typename?: 'Mutation', requestRepair: { __typename?: 'Asset', id: string, assetTag: string, status: string } };
...
export const AssignAssetDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"AssignAsset"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conditionAtAssign"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"accessoriesJson"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"buyoutPolicyId"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"assignedValue"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"paymentPlanMonths"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"interestRate"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"assignAsset"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"assetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}}},{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"conditionAtAssign"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conditionAtAssign"}}},{"kind":"Argument","name":{"kind":"Name","value":"accessoriesJson"},"value":{"kind":"Variable","name":{"kind":"Name","value":"accessoriesJson"}}},{"kind":"Argument","name":{"kind":"Name","value":"buyoutPolicyId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"buyoutPolicyId"}}},{"kind":"Argument","name":{"kind":"Name","value":"assignedValue"},"value":{"kind":"Variable","name":{"kind":"Name","value":"assignedValue"}}},{"kind":"Argument","name":{"kind":"Name","value":"paymentPlanMonths"},"value":{"kind":"Variable","name":{"kind":"Name","value":"paymentPlanMonths"}}},{"kind":"Argument","name":{"kind":"Name","value":"interestRate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"interestRate"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"FragmentSpread","name":{"kind":"Name","value":"AssetFields"}}]}}]}},{"kind":"FragmentDefinition","name":{"kind":"Name","value":"AssetFields"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Asset"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"assetTag"}},{"kind":"Field","name":{"kind":"Name","value":"serialNumber"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"purchaseDate"}},{"kind":"Field","name":{"kind":"Name","value":"purchaseCost"}},{"kind":"Field","name":{"kind":"Name","value":"currentBookValue"}},{"kind":"Field","name":{"kind":"Name","value":"locationId"}},{"kind":"Field","name":{"kind":"Name","value":"locationPath"}},{"kind":"Field","name":{"kind":"Name","value":"assignedTo"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"notes"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]} as unknown as DocumentNode<AssignAssetMutation, AssignAssetMutationVariables>;
...
export const UpdateDataWipeTaskDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateDataWipeTask"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateDataWipeTask"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<UpdateDataWipeTaskMutation, UpdateDataWipeTaskMutationVariables>;
export const EmployeesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"Employees"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"employees"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"entraId"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}},{"kind":"Field","name":{"kind":"Name","value":"firstNameEng"}},{"kind":"Field","name":{"kind":"Name","value":"lastNameEng"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"role"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"signUrl"}},{"kind":"Field","name":{"kind":"Name","value":"hireDate"}},{"kind":"Field","name":{"kind":"Name","value":"terminationDate"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"numberOfVacationDays"}},{"kind":"Field","name":{"kind":"Name","value":"github"}},{"kind":"Field","name":{"kind":"Name","value":"department"}},{"kind":"Field","name":{"kind":"Name","value":"branch"}},{"kind":"Field","name":{"kind":"Name","value":"employeeCode"}},{"kind":"Field","name":{"kind":"Name","value":"level"}},{"kind":"Field","name":{"kind":"Name","value":"isKpi"}},{"kind":"Field","name":{"kind":"Name","value":"isSalaryCompany"}},{"kind":"Field","name":{"kind":"Name","value":"birthDayAndMonth"}},{"kind":"Field","name":{"kind":"Name","value":"birthdayPoster"}},{"kind":"Field","name":{"kind":"Name","value":"createdAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}},{"kind":"Field","name":{"kind":"Name","value":"deletedAt"}}]}}]}}]} as unknown as DocumentNode<EmployeesQuery, EmployeesQueryVariables>;
...
export const GetEmployeeAssignmentsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetEmployeeAssignments"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"employeeAssignments"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"assetId"}},{"kind":"Field","name":{"kind":"Name","value":"employeeId"}},{"kind":"Field","name":{"kind":"Name","value":"assignedAt"}},{"kind":"Field","name":{"kind":"Name","value":"returnedAt"}},{"kind":"Field","name":{"kind":"Name","value":"conditionAtAssign"}},{"kind":"Field","name":{"kind":"Name","value":"conditionAtReturn"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"financing"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"assignedValue"}},{"kind":"Field","name":{"kind":"Name","value":"paymentPlanMonths"}},{"kind":"Field","name":{"kind":"Name","value":"interestRate"}},{"kind":"Field","name":{"kind":"Name","value":"monthlyPayment"}},{"kind":"Field","name":{"kind":"Name","value":"totalPayment"}}]}},{"kind":"Field","name":{"kind":"Name","value":"asset"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"assetTag"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"serialNumber"}},{"kind":"Field","name":{"kind":"Name","value":"imageUrl"}},{"kind":"Field","name":{"kind":"Name","value":"locationId"}},{"kind":"Field","name":{"kind":"Name","value":"locationPath"}},{"kind":"Field","name":{"kind":"Name","value":"purchaseCost"}},{"kind":"Field","name":{"kind":"Name","value":"currentBookValue"}},{"kind":"Field","name":{"kind":"Name","value":"assignedTo"}}]}},{"kind":"Field","name":{"kind":"Name","value":"employee"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"email"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}},{"kind":"Field","name":{"kind":"Name","value":"requestedBy"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"firstName"}},{"kind":"Field","name":{"kind":"Name","value":"lastName"}}]}}]}}]}}]} as unknown as DocumentNode<GetEmployeeAssignmentsQuery, GetEmployeeAssignmentsQueryVariables>;
export const UpdateMaintenanceTicketDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"UpdateMaintenanceTicket"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"status"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"repairCost"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Int"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"resolvedAt"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"updateMaintenanceTicket"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"status"},"value":{"kind":"Variable","name":{"kind":"Name","value":"status"}}},{"kind":"Argument","name":{"kind":"Name","value":"repairCost"},"value":{"kind":"Variable","name":{"kind":"Name","value":"repairCost"}}},{"kind":"Argument","name":{"kind":"Name","value":"resolvedAt"},"value":{"kind":"Variable","name":{"kind":"Name","value":"resolvedAt"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"resolvedAt"}},{"kind":"Field","name":{"kind":"Name","value":"updatedAt"}}]}}]}}]} as unknown as DocumentNode<UpdateMaintenanceTicketMutation, UpdateMaintenanceTicketMutationVariables>;
...
export const StartOffboardingDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"StartOffboarding"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"initiatedBy"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"terminationDate"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"startOffboarding"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"initiatedBy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"initiatedBy"}}},{"kind":"Argument","name":{"kind":"Name","value":"terminationDate"},"value":{"kind":"Variable","name":{"kind":"Name","value":"terminationDate"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<StartOffboardingMutation, StartOffboardingMutationVariables>;
export const SubmitReturnRequestDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"SubmitReturnRequest"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"condition"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conditionDetail"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"photoR2Key"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"submitReturnRequest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"assetId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"assetId"}}},{"kind":"Argument","name":{"kind":"Name","value":"employeeId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"employeeId"}}},{"kind":"Argument","name":{"kind":"Name","value":"condition"},"value":{"kind":"Variable","name":{"kind":"Name","value":"condition"}}},{"kind":"Argument","name":{"kind":"Name","value":"conditionDetail"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conditionDetail"}}},{"kind":"Argument","name":{"kind":"Name","value":"photoR2Key"},"value":{"kind":"Variable","name":{"kind":"Name","value":"photoR2Key"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"assetId"}},{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"conditionEmployee"}}]}}]}}]} as unknown as DocumentNode<SubmitReturnRequestMutation, SubmitReturnRequestMutationVariables>;
...
export const ApproveReturnRequestDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"ApproveReturnRequest"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"returnRequestId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conditionHr"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"inspectedBy"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"approveReturnRequest"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"returnRequestId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"returnRequestId"}}},{"kind":"Argument","name":{"kind":"Name","value":"conditionHr"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conditionHr"}}},{"kind":"Argument","name":{"kind":"Name","value":"inspectedBy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"inspectedBy"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"assetTag"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<ApproveReturnRequestMutation, ApproveReturnRequestMutationVariables>;
export const RequestRepairDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"RequestRepair"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"returnRequestId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"conditionHr"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"photoR2Key"}},"type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"inspectedBy"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"requestRepair"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"returnRequestId"},"value":{"kind":"Variable","name":{"kind":"Name","value":"returnRequestId"}}},{"kind":"Argument","name":{"kind":"Name","value":"conditionHr"},"value":{"kind":"Variable","name":{"kind":"Name","value":"conditionHr"}}},{"kind":"Argument","name":{"kind":"Name","value":"photoR2Key"},"value":{"kind":"Variable","name":{"kind":"Name","value":"photoR2Key"}}},{"kind":"Argument","name":{"kind":"Name","value":"inspectedBy"},"value":{"kind":"Variable","name":{"kind":"Name","value":"inspectedBy"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"assetTag"}},{"kind":"Field","name":{"kind":"Name","value":"status"}}]}}]}}]} as unknown as DocumentNode<RequestRepairMutation, RequestRepairMutationVariables>;
